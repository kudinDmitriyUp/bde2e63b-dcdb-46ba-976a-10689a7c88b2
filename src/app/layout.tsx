...
export const metadata: Metadata = {
  title: "BananaFresh - Premium Quality Bananas Delivered Fresh",
  description: "Order the freshest, sweetest bananas online. Farm-to-table quality, fast delivery, 100% satisfaction guarantee. Premium organic bananas available.",
  keywords: "fresh bananas, organic bananas, banana delivery, premium fruit, healthy snacks, farm fresh",
  ...
  openGraph: {
    title: "BananaFresh - Premium Quality Bananas Delivered Fresh",
    description: "Experience the sweetest, ripest bananas delivered fresh from farm to your table",
    siteName: "BananaFresh",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35ZZe97Tv06RGtie4vGmaUjC38a/uploaded-1763319750508-dffaevh4.jpg",
      alt: "Fresh premium bananas"
    }],
    type: "website"
  },
  twitter: {
    card: "summary_large_image",
    title: "BananaFresh - Premium Quality Bananas",
    description: "Farm-fresh bananas delivered to your door",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35ZZe97Tv06RGtie4vGmaUjC38a/uploaded-1763319750508-dffaevh4.jpg"]
  },
  robots: {
    index: true,
    follow: true
